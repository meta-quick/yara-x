...
///
/// This macro is used by `add_modules.bak`, a file that is automatically
...
lazy_static! {
    ...
    pub(crate) static ref BUILTIN_MODULES: FxHashMap<&'static str, Module> = {
        ...
        // The `add_modules.bak` file is automatically generated at compile time
        // by `build.rs`. This is an example of how `add_modules.bak` looks like:
        //
        // {
        ...
        // }
        //
        // `add_modules.bak` will contain an `add_module!` statement for each
